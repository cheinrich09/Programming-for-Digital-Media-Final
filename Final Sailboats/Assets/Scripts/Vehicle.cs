...
public class Vehicle : MonoBehaviour
{
	...
	public Renderer objRenderer;// = GetComponentInChildren<Renderer>();	
	// mass of vehicle
	...
	private int layerMask = 1 << 4; //mask for a layer containg the terrain
	...
	void Start ()
	{
		...
		halfHeight = objRenderer.bounds.extents.y;
	}
